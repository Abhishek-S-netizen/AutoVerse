    ...
    <div class="dashboard-content">
        ...
        <section class="user_functions_section">
            <div class="welcome-message">
                <h2 style="font-family:Audiowide;">
                    Welcome, {{ Auth::user()->name }}
                </h2>
            </div>

            <div class="user_functions_div">
                <div class="d-flex flex-column gap-5 wishlist_card">
                    <div class="container d-flex">
                        <h2 class="card_title"> 
                ...
                <div class="d-flex flex-column gap-5 order_card">
                    <div class="container d-flex">
                        <h2 class="card_title"> 
                            <i class="fa-solid fa-hourglass-half"></i> Live Orders
                        </h2>
                    </div>

                    <div class="container d-flex flex-column">
                        <h3>
                            {{ $rentedCountCurrent }} <span class="fs-5"> current order(s)</span>
                        </h3>
                ...
                <div class="d-flex flex-column gap-5 order_card">
                    <div class="container d-flex">
                        <h2 class="card_title"> 
                            <i class="fa-solid fa-clock-rotate-left"></i> Past Orders
                        </h2>
                    </div>

                    <div class="container d-flex flex-column">
                        <h3>
                            {{ $rentedCountPast }} <span class="fs-5">past order(s)</span>
                        </h3>
