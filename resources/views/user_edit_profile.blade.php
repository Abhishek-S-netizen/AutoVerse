...
<body>
    @include("loader")
    <div class="parallax" style="background: url('{{ asset('images/polestar_2_demo.jpg') }}') center/cover no-repeat">
    @if(session('success'))
    ...
    <form method="POST" action="/update-user-details">
        ...
        <div class="container mb-5 d-flex justify-content-center">
            <h1 style="font-family:Audiowide;">Edit profile details</h1>
        </div>
        ...
        <div class="row mb-3 justify-content-center">
            <div class="col-sm-10">
                <input type="email" name="email" class="form-control" id="inputEmail3" placeholder="Email" value="{{ $user->email }}" required>
            </div>
        </div>
        ...
        <button type="submit" class="btn mt-5 fw-bolder">Update details</button>
    </form>
    </div>
