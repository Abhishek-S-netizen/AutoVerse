...
<body>
    @include("loader")
    <div class="parallax" style="background: url('{{ asset('images/polestar_2.jpg') }}') center/cover no-repeat">
    @if($errors->any())
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="container mb-5 d-flex justify-content-center bg-dark">
...
<body>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- <div class="d-flex flex-wrap mb-3 justify-content-center">
                <input type="text" class="d-inline" id="inputName" name="name" placeholder="Name" required>

                <input type="email" class="d-inline" id="inputEmail3" name="email" placeholder="Email" required>
        </div>
